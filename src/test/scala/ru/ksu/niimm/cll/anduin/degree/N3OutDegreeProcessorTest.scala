...
class N3OutDegreeProcessorTest extends JUnit4(N3OutDegreeProcessorTestSpec)

object N3OutDegreeProcessorTestSpec extends Specification with TupleConversions {
