...
class NquadCollectionObjectLinkFrequencyProcessorTest extends JUnit4(NquadCollectionObjectLinkFrequencyProcessorTestSpec)

object NquadCollectionObjectLinkFrequencyProcessorTestSpec extends Specification with TupleConversions {
  "The collection object link frequency processor job" should {
    JobTest("ru.ksu.niimm.cll.anduin.adjacency.CollectionObjectLinkFrequencyProcessor").
      arg("input", "inputFile").
